...
const googleClientId =
  '561871153864-i08nqb0tu0rpa5kkd5gpkp3sqspfmdvl.apps.googleusercontent.com'
    ...
    <List isLoading={isLoading}>
      ...
      {idTokenData && (
        <List.Section title='ID Token Claims (Decoded JWT)'>
          ...
          />
          <List.Item title='Name' subtitle={idTokenData.name || 'N/A'} />
          <List.Item
            title='Subject (User ID)'
            subtitle={idTokenData.sub || 'N/A'}
          />
          <List.Item title='Issuer' subtitle={idTokenData.iss || 'N/A'} />
          <List.Item
          ...
          <List.Item
            ...
            subtitle={
              idTokenData.iat
                ? new Date(idTokenData.iat * 1000).toLocaleString()
                : 'N/A'
            }
          />
          <List.Item
            ...
            subtitle={
              idTokenData.exp
                ? new Date(idTokenData.exp * 1000).toLocaleString()
                : 'N/A'
            }
          />
          {idTokenData.picture && (
            <List.Item title='Profile Picture' subtitle={idTokenData.picture} />
          )}
        </List.Section>
      )}
