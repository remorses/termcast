...
function MainView(): any {
  ...
  const items = [
    { id: "first", title: "First Item", subtitle: "Navigate to first detail" },
    { id: "second", title: "Second Item", subtitle: "Navigate to second detail" },
    { id: "third", title: "Third Item", subtitle: "Navigate to third detail" }
  ]
