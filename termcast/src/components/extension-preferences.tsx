...
import { Form, showToast, Toast } from '@termcast/api'
...
import { getStoreDirectory } from '@termcast/api/src/store'
import type { RaycastPackageJson } from '@termcast/api/src/package-json'
...
interface PreferenceManifest {
    name: string
    type: 'textfield' | 'password' | 'checkbox' | 'dropdown' | 'file' | 'directory' | 'appPicker'
    title: string
    description?: string
    required?: boolean
    placeholder?: string
                    ...
                    case 'appPicker':
                        return (
                            <Form.TextField
                                ...
                                title={pref.title}
                                placeholder={
                                    pref.type === 'file' ? 'Enter file path' : 
                                    pref.type === 'directory' ? 'Enter directory path' :
                                    'Enter application name'
                                }
                                defaultValue={defaultValue}
                                info={pref.description || `Select a ${pref.type.replace('appPicker', 'application')}`}
                                storeValue={true}
                            />
                        )
